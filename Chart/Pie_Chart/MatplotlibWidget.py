...
class MyMplCanvas(FigureCanvas):
    ...
    # def set_chart_x_axes(self, value):
    #     self.arangeAxesX = value

    # def set_chart_y_axes(self, value):
    #     self.arangeAxesY = value

    # def show(self):
    #     self.axes.plot(self.arangeAxesX, self.arangeAxesY)



class CtrlMatplotlibWidget(QWidget, MyMplCanvas):
    def __init__(self, parent=None):
        super(CtrlMatplotlibWidget, self).__init__(parent)
